...
public class DrawerManager {
    ...
    public static void buildDrawer(MobileApplication app) {
        ...
        drawer.getItems().addAll(startseiteItem, eigeneTrainings, wochenplan, bildAuswaehlen, einheitBearbeiten, trainingDurchfuehren, uebungAuswaehlen, uebungBearbeiten,uebungNotBearbeiten );
