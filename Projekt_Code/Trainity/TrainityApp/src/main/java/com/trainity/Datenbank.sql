...
-- ÄNDERUNGEN NACHTRÄGLICH
ALTER table trainingsuebung ADD wiederholungen numeric(3);


ALTER TABLE trainingsuebung
DROP COLUMN trainingseinheit_id;
/*
select * from trainingsuebung;


insert into trainingsuebung("Name",BESCHREIBUNG, BESITZER, BENUTZER_ID, BILD_ID, WIEDERHOLUNGEN) VALUES('Julian', 'sdasd', 'besitzer', 4, 5, 10);
